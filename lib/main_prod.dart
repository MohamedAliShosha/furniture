...
import 'package:furniture/config/firebase_options_prod.dart';
...
Future<void> main() async {
  ...
  setupServiceLocator();
  runApp(const FurnitureProd());
}

class FurnitureProd extends StatelessWidget {
  const FurnitureProd({super.key});
